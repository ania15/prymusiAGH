...
class Review(models.Model):
    book = models.ForeignKey(
        to="books.Book",
        verbose_name="recenzowana książka", 
        on_delete=models.CASCADE
    )
    author = models.CharField(verbose_name="autor recenzji", max_length=100)
    ...
    def __str__(self):
        return "Recenzja: " + self.book.title + "napisana przez " + self.author
# b = Book()
